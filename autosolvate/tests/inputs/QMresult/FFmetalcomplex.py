...
def startFFgen(argumentList):
    options = 'hn:c:u:m:f:t:x:p:M:r:G:s:o:l:A:Q:W:e:b:k:'
    ...
    for currentArgument, currentValue in arguments:
        if currentArgument in ("-h", "--help"):
            ...
            Options:
                ...
                -t, --totalcharge       total charge of the whole system, the default is caluated after charge assignment
                -p, --nprocs             procs to run orca QM calculation, if -x orca
                -G  --qmexe             path to QM exe
                -o  --method            method of QM default:B3LYP
                -l  --solventoff        path to the custom solvent .off library file
                -r  --solventfrcmod     path to the custom solvent .frcmod file
                ...
                -k  --closeness         Solute-solvent closeness setting
        ...
        elif currentArgument in ('-t','--totalcharge'):
        ...
        elif currentArgument in ('-r','--solventfrcmod'):
        ...
        elif currentArgument in ('-k','-closeness'):
